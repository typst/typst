...
--- decimal-constructor-bad-type paged diagnostic ---
// Error: 10-17 expected decimal, integer, boolean, float, or string, found type
#decimal(decimal)

--- decimal-constructor-bad-value paged diagnostic ---
// Error: 10-17 invalid decimal: 1.2.3
#decimal("1.2.3")

--- decimal-constructor-float-literal paged diagnostic ---
...
--- decimal-constructor-float-inf paged diagnostic ---
// Error: 10-19 float is not a valid decimal: float.inf
#decimal(float.inf)

--- decimal-constructor-float-negative-inf paged diagnostic ---
// Error: 10-20 float is not a valid decimal: -float.inf
#decimal(-float.inf)

--- decimal-constructor-float-nan paged diagnostic ---
...
--- decimal-expected-integer-error paged diagnostic ---
