...
--- decimal-constructor-bad-type render ---
// Error: 10-17 expected decimal, integer, boolean, float, or string, found type
#decimal(decimal)

--- decimal-constructor-bad-value render ---
// Error: 10-17 invalid decimal: 1.2.3
#decimal("1.2.3")

--- decimal-constructor-float-literal render ---
...
--- decimal-constructor-float-inf render ---
// Error: 10-19 float is not a valid decimal: float.inf
#decimal(float.inf)

--- decimal-constructor-float-negative-inf render ---
// Error: 10-20 float is not a valid decimal: -float.inf
#decimal(-float.inf)

--- decimal-constructor-float-nan render ---
// Error: 10-19 float is not a valid decimal: float.nan
#decimal(float.nan)

--- decimal-scale-is-observable render ---
...
--- decimal-expected-float-error render ---
...
--- decimal-expected-integer-error render ---
