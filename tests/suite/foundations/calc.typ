...
--- calc-round-large-inputs render ---
...
--- calc-rem-euclid-divisor-zero-1 render ---
// Error: 21-22 divisor must not be zero
#calc.rem-euclid(5, 0)

--- calc-rem-euclid-divisor-zero-2 render ---
// Error: 23-26 divisor must not be zero
#calc.rem-euclid(3.0, 0.0)

--- calc-rem-euclid-divisor-zero-3 render ---
// Error: 35-50 divisor must not be zero
...
--- calc-quo-divisor-zero-1 render ---
// Error: 14-15 divisor must not be zero
#calc.quo(5, 0)

--- calc-quo-divisor-zero-2 render ---
// Error: 16-19 divisor must not be zero
#calc.quo(3.0, 0.0)

--- calc-quo-divisor-zero-3 render ---
// Error: 27-41 divisor must not be zero
#calc.quo(decimal("4.0"), decimal("0.0"))

--- calc-min-and-max render ---
...
--- calc-norm-negative-p render ---
// Error: 15-17 p must be greater than zero
#calc.norm(p: -1, 1)

--- calc-norm-expected-float render ---
