...
--- calc-abs-bad-type paged diagnostic ---
...
--- calc-rem-divisor-zero-1 paged diagnostic ---
// Error: 14-15 divisor must not be zero
#calc.rem(5, 0)

--- calc-rem-divisor-zero-2 paged diagnostic ---
// Error: 16-19 divisor must not be zero
#calc.rem(3.0, 0.0)

--- calc-rem-divisor-zero-3 paged diagnostic ---
...
--- calc-div-euclid-divisor-zero-1 paged diagnostic ---
// Error: 21-22 divisor must not be zero
#calc.div-euclid(5, 0)

--- calc-div-euclid-divisor-zero-2 paged diagnostic ---
// Error: 23-26 divisor must not be zero
#calc.div-euclid(3.0, 0.0)

--- calc-div-euclid-divisor-zero-3 paged diagnostic ---
...
--- calc-rem-euclid-divisor-zero-1 paged diagnostic ---
// Error: 21-22 divisor must not be zero
#calc.rem-euclid(5, 0)

--- calc-rem-euclid-divisor-zero-2 paged diagnostic ---
// Error: 23-26 divisor must not be zero
#calc.rem-euclid(3.0, 0.0)

--- calc-rem-euclid-divisor-zero-3 paged diagnostic ---
// Error: 35-50 divisor must not be zero
...
--- calc-quo-divisor-zero-1 paged diagnostic ---
// Error: 14-15 divisor must not be zero
#calc.quo(5, 0)

--- calc-quo-divisor-zero-2 paged diagnostic ---
// Error: 16-19 divisor must not be zero
#calc.quo(3.0, 0.0)

--- calc-quo-divisor-zero-3 paged diagnostic ---
...
--- calc-fact-too-large paged diagnostic ---
...
--- calc-perm-too-large paged diagnostic ---
...
--- calc-lcm-too-large paged diagnostic ---
...
--- calc-floor-float-larger-than-max-int paged diagnostic ---
// Error: 2-35 the result is too large
#calc.floor(9223372036854775809.5)

--- calc-floor-decimal-larger-than-max-int paged diagnostic ---
...
--- calc-floor-float-smaller-than-min-int paged diagnostic ---
// Error: 2-36 the result is too large
#calc.floor(-9223372036854775809.5)

--- calc-floor-decimal-smaller-than-min-int paged diagnostic ---
// Error: 2-47 the result is too large
#calc.floor(decimal("-9223372036854775809.5"))

--- calc-round-int-too-large paged diagnostic ---
// Error: 2-45 the result is too large
#calc.round(9223372036854775807, digits: -1)

--- calc-round-int-negative-too-large paged diagnostic ---
// Error: 2-46 the result is too large
#calc.round(-9223372036854775807, digits: -1)

--- calc-round-decimal-too-large paged diagnostic ---
// Error: 2-66 the result is too large
#calc.round(decimal("79228162514264337593543950335"), digits: -1)

--- calc-round-decimal-negative-too-large paged diagnostic ---
// Error: 2-67 the result is too large
#calc.round(decimal("-79228162514264337593543950335"), digits: -1)

--- calc-min-nothing paged diagnostic ---
// Error: 2-12 expected at least one value
#calc.min()

--- calc-min-uncomparable paged diagnostic ---
// Error: 14-18 cannot compare string and integer
#calc.min(1, "hi")

--- calc-max-uncomparable paged diagnostic ---
// Error: 16-19 cannot compare 1pt with 1em
#calc.max(1em, 1pt)

--- calc-clamp-decimal-float paged diagnostic ---
...
--- calc-norm-negative-p paged diagnostic ---
// Error: 15-17 p must be greater than zero
#calc.norm(p: -1, 1)

--- calc-norm-expected-float paged diagnostic ---
