...
--- spread-array-into-dict paged diagnostic ---
...
--- dict-at-missing-key paged diagnostic ---
...
--- dict-missing-lvalue paged diagnostic ---
...
--- dict-temporary-lvalue paged diagnostic ---
// Error: 3-15 cannot mutate a temporary value
#((key: "val").other = "some")

--- dict-function-item-not-a-method paged diagnostic ---
#{
  let dict = (
    call-me: () => 1,
  )
...
--- dict-item-missing-method paged diagnostic ---
#{
  let dict = (
    nonfunc: 1
  )
...
--- issue-1338-dictionary-underscore paged diagnostic ---
#let foo = "foo"
#let bar = "bar"
...
--- issue-3154-dict-at-missing-mutable paged diagnostic ---
#{
  let dict = (a: 1)
...
--- issue-3154-dict-at-missing-mutable-default paged diagnostic ---
#{
  let dict = (a: 1)
...
--- issue-3154-dict-syntax-missing paged diagnostic ---
#{
  let dict = (a: 1)
...
--- issue-3154-dict-syntax-missing-add-assign paged diagnostic ---
#{
  let dict = (a: 1)
  // Error: 3-9 dictionary does not contain key "b"
  // Hint: 3-9 use `insert` to add or update values
...
--- issue-3232-dict-unexpected-keys-sides paged diagnostic ---
...
--- issue-3232-dict-unexpected-keys-corners paged diagnostic ---
// Error: 14-56 unexpected keys "unexpected" and "unexpected-too"
#box(radius: (unexpected: 0.5em, unexpected-too: 0.5em), [Hi])

--- issue-3232-dict-unexpected-key-sides paged diagnostic ---
...
--- issue-3232-dict-unexpected-key-corners paged diagnostic ---
