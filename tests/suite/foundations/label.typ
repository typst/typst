...
--- label-show-where-selector render ---
...
--- label-multiple-ignored-warn paged diagnostic ---
...
--- label-unattached-warn paged diagnostic ---
#set heading(numbering: "1.")
// Warning: 1-4 label `<a>` is not attached to anything
<a>

--- label-non-existent-error paged diagnostic ---
// Error: 5-10 sequence does not have field "label"
#[].label

--- label-empty paged diagnostic ---
