...
--- str-from-unicode-bad-type paged diagnostic ---
// Error: 19-22 expected integer, found content
#str.from-unicode([a])

--- str-to-unicode-bad-type paged diagnostic ---
// Error: 17-21 expected exactly one character
#str.to-unicode("ab")

--- str-from-unicode-negative paged diagnostic ---
// Error: 19-21 number must be at least zero
#str.from-unicode(-1)

--- str-from-unicode-bad-value paged diagnostic ---
...
--- string-first-empty paged diagnostic ---
// Error: 2-12 string is empty
#"".first()

--- string-last-empty paged diagnostic ---
...
--- string-at-not-a-char-boundary paged diagnostic ---
// Error: 2-14 string index 2 is not a character boundary
#"🏳️‍🌈".at(2)

--- string-at-out-of-bounds paged diagnostic ---
...
--- string-slice-count-end paged diagnostic ---
// Error: 2-29 `end` and `count` are mutually exclusive
#"abc".slice(0, 1, count: 2)

--- string-slice-not-a-char-boundary paged diagnostic ---
...
--- string-replace-function-bad-type paged diagnostic ---
// Error: 23-24 expected string, found integer
#"123".replace("123", m => 1)

--- string-replace-bad-type paged diagnostic ---
...
--- string-trim-at-bad-alignment paged diagnostic ---
...
--- string-unclosed paged diagnostic ---
