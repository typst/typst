...
--- int-base-binary-invalid paged diagnostic ---
// Error: 2-7 invalid binary number: 0b123
#0b123

--- int-base-hex-invalid paged diagnostic ---
...
--- int-constructor-bad-type paged diagnostic ---
// Error: 6-10 expected integer, boolean, float, decimal, or string, found length
#int(10pt)

--- int-constructor-bad-value paged diagnostic ---
// Error: 6-12 invalid integer: nope
#int("nope")

--- int-constructor-float-too-large paged diagnostic ---
// Error: 6-27 number too large
#int(9223372036854775809.5)

--- int-constructor-float-too-large-min paged diagnostic ---
// Error: 6-28 number too large
#int(-9223372036854775809.5)

--- int-constructor-decimal-too-large paged diagnostic ---
// Error: 6-38 number too large
#int(decimal("9223372036854775809.5"))

--- int-constructor-decimal-too-large-min paged diagnostic ---
...
--- int-from-and-to-bytes-too-many paged diagnostic ---
...
--- number-invalid-suffix paged diagnostic ---
