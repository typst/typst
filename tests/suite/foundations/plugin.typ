...
--- plugin-wrong-number-of-arguments paged diagnostic ---
#let p = plugin("/assets/plugins/hello.wasm")

// Error: 2-20 plugin function takes 0 arguments, but 1 was given
#p.hello(bytes(""))

--- plugin-wrong-argument-type paged diagnostic ---
#let p = plugin("/assets/plugins/hello.wasm")
...
--- plugin-out-of-bounds-write paged diagnostic ---
#let p = plugin("/assets/plugins/plugin-oob.wasm")
