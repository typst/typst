...
--- symbol-constructor-empty render ---
// Error: 2-10 expected at least one variant
#symbol()

--- symbol-constructor-invalid-modifier render ---
// Error: 2:3-2:24 invalid symbol modifier: " id!"
#symbol(
  ("invalid. id!", "x")
)

--- symbol-constructor-duplicate-modifier render ---
...
--- symbol-constructor-duplicate-default-variant render ---
...
--- symbol-constructor-duplicate-empty-variant render ---
...
--- symbol-constructor-default-and-empty-variants render ---
// Error: 3:3-3:12 duplicate default variant
#symbol(
  "x",
  ("", "y"),
...
--- symbol-constructor-duplicate-variant render ---
...
--- symbol-constructor-duplicate-variant-different-order render ---
...
--- symbol-constructor-empty-variant-value render ---
...
--- symbol-constructor-multi-cluster-variant-value render ---
...
--- symbol-unknown-modifier render ---
