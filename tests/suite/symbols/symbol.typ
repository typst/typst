...
--- symbol-constructor-empty paged diagnostic ---
// Error: 2-10 expected at least one variant
#symbol()

--- symbol-constructor-invalid-modifier paged diagnostic ---
// Error: 2:3-2:24 invalid symbol modifier: " id!"
#symbol(
  ("invalid. id!", "x")
)

--- symbol-constructor-duplicate-modifier paged diagnostic ---
...
--- symbol-constructor-duplicate-default-variant paged diagnostic ---
...
--- symbol-constructor-duplicate-empty-variant paged diagnostic ---
...
--- symbol-constructor-default-and-empty-variants paged diagnostic ---
// Error: 3:3-3:12 duplicate default variant
#symbol(
  "x",
  ("", "y"),
...
--- symbol-constructor-duplicate-variant paged diagnostic ---
...
--- symbol-constructor-duplicate-variant-different-order paged diagnostic ---
...
--- symbol-constructor-empty-variant-value paged diagnostic ---
...
--- symbol-constructor-multi-cluster-variant-value paged diagnostic ---
...
--- symbol-unknown-modifier paged diagnostic ---
...
--- symbol-sect-deprecated render ---
// Warning: 5-9 `sect` is deprecated, use `inter` instead
$ A sect B = A inter B $

--- symbol-modifier-deprecated render ---
...
--- issue-5930-symbol-label render ---
#emoji.face<lab>
#context test(query(<lab>).first().text, "😀")

--- presentation-selectors render ---
