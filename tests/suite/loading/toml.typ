...
--- toml-decode-integer-too-large paged diagnostic ---
...
--- toml-decode-integer-too-small paged diagnostic ---
#import "edge-case.typ": large-integer
...
--- toml-encode-non-table paged diagnostic ---
// Error: 14-15 expected dictionary, found integer
#toml.encode(3)

--- toml-decode-non-table paged diagnostic ---
