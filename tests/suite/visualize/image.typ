...
--- image-svg-auto-detection render ---
#image(bytes(
  ```
...
--- image-svg-linked-many-formats render ---
#set page(width: auto, height: auto, margin: 1pt)
#set text(1pt)
#image("../../../assets/images/linked.svg", width: 39pt)

--- image-svg-linked-file-not-found paged diagnostic ---
...
--- image-svg-linked-url paged diagnostic ---
...
--- image-svg-linked-pdf paged diagnostic ---
...
--- image-svg-linked-csv paged diagnostic ---
...
--- image-svg-linked-absolute1 paged diagnostic ---
...
--- image-svg-linked-absolute2 paged diagnostic ---
...
--- image-natural-dpi-sizing render ---
...
--- image-decode-bad-svg paged diagnostic ---
...
--- image-pixmap-empty paged diagnostic ---
...
--- image-pixmap-invalid-size paged diagnostic ---
...
--- image-pixmap-unknown-attribute paged diagnostic ---
#image(
  bytes((0x00, 0x00, 0x00)),
...
--- image-pixmap-but-png-format paged diagnostic ---
#image(
  bytes((0x00, 0x00, 0x00)),
...
--- image-png-but-pixmap-format paged diagnostic ---
#image(
