...
--- image-svg-linked-file-not-found render ---
...
--- image-svg-linked-absolute1 render ---
...
--- image-svg-linked-absolute2 render ---
...
--- image-decode-specify-wrong-format render ---
...
--- image-pixmap-invalid-size render ---
...
--- image-pixmap-unknown-attribute render ---
#image(
  bytes((0x00, 0x00, 0x00)),
...
--- image-pixmap-but-png-format render ---
#image(
  bytes((0x00, 0x00, 0x00)),
...
--- image-png-but-pixmap-format render ---
#image(
