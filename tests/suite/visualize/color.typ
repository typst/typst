...
--- color-mix-bad-value paged diagnostic ---
// Error: 12-23 expected a color or color-weight pair
#color.mix((red, 1, 2))

--- color-mix-bad-space-type paged diagnostic ---
