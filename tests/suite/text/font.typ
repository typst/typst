...
--- issue-5499-text-fill-in-clip-block render ---
...
--- text-font-covers-numbers render ---
...
--- text-font-covers-repeat render ---
...
--- text-font-covers-riffle render ---
...
--- text-font-covers-bad-1 paged diagnostic ---
...
--- text-font-covers-bad-2 paged diagnostic ---
...
--- issue-5262-text-negative-size render ---
#set text(-1pt)

a

--- issue-5940-text-negative-size-panic render ---
#set align(center)
#set text(-10pt)
Hello

--- empty-text-font-array paged diagnostic ---
