...
--- math-equation-numbering render ---
...
--- math-equation-font render ---
// Test different font.
#show math.equation: set text(font: "Fira Math")
$ v := vec(1 + 2, 2 - 4, sqrt(3), arrow(x)) + 1 $

--- math-equation-show-rule render ---
This is small: $sum_(i=0)^n$

#show math.equation: math.display
This is big: $sum_(i=0)^n$

--- math-equation-align-unnumbered render ---
// Test unnumbered
#let eq(alignment) = {
...
--- math-equation-align-numbered render ---
// Test numbered
#let eq(alignment) = {
  show math.equation: set align(alignment)
  $ a + b = c $
...
--- math-equation-number-align render ---
#set math.equation(numbering: "(1)")
...
--- math-equation-number-align-start render ---
...
--- math-equation-number-align-end render ---
...
--- math-equation-number-align-left render ---
...
--- math-equation-number-align-right render ---
...
--- math-equation-number-align-multiline render ---
#set math.equation(numbering: "(1)")

$ p &= ln a b \
    &= ln a + ln b $

--- math-equation-number-align-multiline-top-start render ---
...
--- math-equation-number-align-multiline-bottom render ---
#show math.equation: set align(left)
#set math.equation(numbering: "(1)", number-align: bottom)
...
--- math-equation-number-align-multiline-expand render ---
...
--- math-equation-number-align-multiline-no-expand render ---
...
--- math-equation-number-empty render ---
// Test numbering on empty equations.
#math.equation(numbering: "1", block: true, [])

--- math-equation-tag-affects-row-height render ---
...
--- issue-4187-alignment-point-affects-row-height render ---
...
--- issue-numbering-hint paged diagnostic ---
...
--- issue-3696-equation-rtl render ---
#set page(width: 150pt)
#set text(lang: "he")
תהא סדרה $a_n$: $[a_n: 1, 1/2, 1/3, dots]$

--- issue-6170-equation-stroke render ---
