...
--- math-root-basic render ---
// Test root with more than one character.
$A = sqrt(x + y) = c$

--- math-root-radical-attachment render ---
...
--- math-root-syntax render ---
// Test shorthand.
$ √2^3 = sqrt(2^3) $
$ √(x+y) quad ∛x quad ∜x $
$ (√2+3) = (sqrt(2)+3) $

--- math-root-syntax-prec render ---
// Precedence of root syntax with other math operators.
$ √a/b ∛a_b ∜f' √n! \
  √a b^c  √a (b)^c  √a(b)^c $

--- math-root-frame-size-index render ---
