...
--- math-lr-fences render ---
// Test fence confusion.
$ |x + |y| + z/a| \
  lr(|x + |y| + z/a|) $

--- math-lr-symbol-unmatched render ---
...
--- math-lr-mid-size-nested-equation render ---
...
--- math-lr-unbalanced render ---
// Test unbalanced delimiters.
$ 1/(2 (x) $
$ 1_(2 y (x) () $
$ 1/(2 y (x) (2(3)) $

--- math-lr-weak-spacing render ---
...
--- math-lr-ignore-ignorant render ---
...
--- issue-4188-lr-corner-brackets render ---
// Test positioning of U+231C to U+231F
$⌜a⌟⌞b⌝$ = $⌜$$a$$⌟$$⌞$$b$$⌝$

--- math-lr-unparen render ---
