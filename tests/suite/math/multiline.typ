...
#let hrule(x) = box(line(length: x))
// Warning: 13-31 inconsistent spacing inside dollar signs
// Hint: 13-31 this is being treated as an inline equation
// Hint: 13-31 a block-level equation requires whitespace inside both dollar signs
// Hint: 13-31 an inline equation should not have whitespace inside either dollar sign
