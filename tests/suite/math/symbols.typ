...
--- math-symbol-underscore paged diagnostic ---
#let sym = symbol("s", ("test_underscore", "s"))
// Error: 6-10 unknown symbol modifier
$sym.test_underscore$

--- math-symbol-dash paged diagnostic ---
