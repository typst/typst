...
--- math-call-non-func render ---
$ pi(a) $
$ pi(a,) $
$ pi(a,b) $
$ pi(a,b,) $

--- math-call-unclosed-func paged diagnostic ---
#let func(x) = x
// Error: 6-7 unclosed delimiter
$func(a$

--- math-call-unclosed-non-func paged diagnostic ---
// Error: 5-6 unclosed delimiter
$sin(x$

--- math-call-named-args render ---
...
--- math-call-named-args-no-expr paged diagnostic ---
#let func(m: none) = m
// Error: 10 expected expression
$ func(m: ) $

--- math-call-named-args-duplicate paged diagnostic ---
#let func(my: none) = my
// Error: 15-17 duplicate argument: my
$ func(my: a, my: b) $

--- math-call-named-args-shorthand-clash-1 paged diagnostic ---
#let func(m: none) = m
// Error: 18-21 unexpected argument
$func(m: =) func(m:=)$

--- math-call-named-args-shorthand-clash-2 paged diagnostic ---
#let func(m: none) = m
// Error: 41-45 unexpected argument
$func(m::) func(m: :=) func(m:: =) func(m::=)$

--- math-call-named-single-underscore paged diagnostic ---
#let func(x) = x
// Error: 8-9 expected identifier, found underscore
$ func(_: a) $

--- math-call-named-single-char-error paged diagnostic ---
#let func(m: none) = m
// Error: 8-13 unexpected argument
$ func(m : a) $

--- math-call-named-args-repr render ---
#let args(..body) = body
...
--- math-call-spread-content-error paged diagnostic ---
#let args(..body) = body
// Error: 7-16 cannot spread content
$args(..(a + b))$

--- math-call-spread-multiple-exprs paged diagnostic ---
#let args(..body) = body
// Error: 7-14 cannot spread content
$args(..a + b)$

--- math-call-spread-unexpected-dots paged diagnostic ---
#let args(..body) = body
// Error: 8-10 unexpected dots
$args(#..range(1, 5).chunks(2))$

--- math-call-spread-shorthand-clash render ---
#let func(body) = body
$func(...)$

--- math-call-spread-empty render ---
...
--- math-call-named-spread-override render ---
...
--- math-call-named-spread-duplicate paged diagnostic ---
...
--- math-call-2d-named-repr render ---
...
--- math-call-2d-escape-repr render ---
#let args(..body) = body
#let check(it, r) = test-repr(it.body.text, r)
#check($args(a\;b)$, "arguments(sequence([a], [;], [b]))")
...
--- math-call-2d-repr-structure render ---
#let args(..body) = body
#let check(it, r) = test-repr(it.body.text, r)
#check($args( a; b; )$, "arguments(([a],), ([b],))")
...
--- math-call-value-non-func paged diagnostic ---
$ sin(1) $
// Error: 8-9 expected content, found integer
$ sin(#1) $

--- math-call-pass-to-box render ---
...
--- math-call-unknown-var-hint paged diagnostic ---
...
--- math-call-symbol render ---
$ phi(x) $
$ phi(x, y) $
$ phi(1,2,,3,) $

--- math-call-symbol-named-argument paged diagnostic ---
// Error: 10-18 unexpected argument: alpha
$ phi(x, alpha: y) $

--- issue-3774-math-call-empty-2d-args render ---
$ mat(;,) $
