...
// Ensure a footnote in text after heading doesn't cause an orphan.
...
// Ensure a footnote in text after heading allows an orphan when there isn't
// enough space.
...
// Ensure a footnote in text allows a widow when there isn't enough space.
#set page(height: 60pt)
