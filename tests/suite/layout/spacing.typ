...
--- spacing-missing-amount render ---
// Missing spacing.
// Error: 10-13 missing argument: amount
Totally #h() ignored

--- issue-3624-spacing-behaviour render ---
...
--- trim-weak-space-line-beginning render ---
// Weak space at the beginning should be removed.
#h(2cm, weak: true) Hello

--- trim-weak-space-line-end render ---
...
--- issue-5244-consecutive-weak-space render ---
...
--- issue-5244-consecutive-weak-space-heading render ---
#set par(justify: true)
#set heading(numbering: "I.")

= #h(0.3em, weak: true) test

--- issue-5253-consecutive-weak-space-math render ---
$= thin thin$ a
