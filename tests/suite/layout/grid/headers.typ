...
--- grid-header-relative-row-sizes render ---
// Relative lengths
...
--- grid-header-cell-with-y render ---
#grid(
  grid.cell(y: 1)[a],
...
--- grid-header-cell-with-x render ---
#grid(
  columns: 2,
  stroke: black,
  inset: 5pt,
...
--- grid-header-hline-and-vline render ---
...
--- grid-header-not-at-first-row render ---
#grid(
  [a],
  grid.header([b])
)

--- grid-header-not-at-first-row-two-columns render ---
#grid(
  columns: 2,
  [a],
  grid.header([b])
...
--- grid-header-multiple-unordered render ---
#set page(height: 4em)
#grid(
...
--- grid-header-skip-unordered render ---
#grid(
  columns: 2,
  [a],
...
--- grid-header-rowbreak-auto-pos render ---
#grid(
  columns: 2,
  [x],
...
--- grid-header-rowbreak-fixed-pos render ---
#grid(
  columns: 2,
  [z],
  grid.hline(stroke: red),
...
--- grid-header-rowbreak-mixed-pos render ---
#grid(
  columns: 2,
  [a],
...
--- grid-header-rowbreak-auto-and-fixed-pos render ---
#grid(
  columns: 2,
  [a],
  grid.header([x]),
...
--- grid-header-too-large-non-repeating-orphan render ---
#set page(height: 8em)
#grid(
  grid.header(
    [a\ ] * 5,
...
--- grid-header-too-large-repeating-orphan render ---
#set page(height: 8em)
#grid(
  grid.header(
    [a\ ] * 5,
...
--- grid-header-too-large-repeating-orphan-with-footer render ---
#set page(height: 8em)
#grid(
  grid.header(
    [a\ ] * 5,
...
--- grid-header-too-large-repeating-orphan-not-at-first-row render ---
#set page(height: 8em)
#grid(
  [b],
  grid.header(
...
--- table-header-in-grid paged diagnostic ---
...
--- grid-header-in-table paged diagnostic ---
...
--- grid-header-and-rowspan-non-contiguous-1 render ---
...
--- grid-header-and-rowspan-non-contiguous-2 render ---
// Rowspan sizing algorithm doesn't do the best job at non-contiguous content
// ATM.
#set page(height: 15em)
...
--- grid-header-and-rowspan-non-contiguous-3 render ---
...
--- grid-header-and-rowspan-contiguous-1 render ---
...
--- grid-header-and-rowspan-contiguous-2 render ---
// Block should occupy all space
#set page(height: 15em)
...
--- grid-header-and-large-auto-contiguous render ---
// Block should occupy all space
#set page(height: 15em)
...
--- grid-header-lack-of-space render ---
...
--- grid-header-orphan-prevention render ---
...
--- grid-header-non-repeating-orphan-prevention render ---
#set page(height: 5em)
#v(2em)
#grid(
...
--- grid-header-containing-rowspan render ---
...
--- grid-header-no-expand-with-col-and-row-pos-cell paged diagnostic ---
#set page(height: 10em)
#table(
  columns: 2,
  table.header(
...
--- grid-header-no-expand-with-row-pos-cell paged diagnostic ---
#set page(height: 10em)
#table(
  columns: 2,
  table.header(
...
--- grid-nested-with-headers render ---
...
--- grid-header-not-at-the-top render ---
#set page(height: 5em)
#v(2em)
#grid(
  [a],
...
--- grid-header-replace-orphan render ---
#set page(height: 5em)
#grid(
  grid.header[*Abc*],
  [a],
...
--- grid-header-replace-doesnt-fit render ---
#set page(height: 5em)
#v(0.8em)
#grid(
  grid.header[*Abc*],
...
--- grid-header-stroke-edge-cases render ---
...
--- grid-header-hline-bottom render ---
...
--- grid-header-hline-bottom-manually render ---
...
--- grid-header-rowspan-base render ---
#set page(height: 7em)
#set text(6pt)
...
--- grid-header-row-pos-cell-inside-conflicts-with-row-before paged diagnostic ---
#set page(margin: 2pt)
#set text(6pt)
#table(
  columns: 3,
...
--- grid-header-row-pos-cell-inside-conflicts-with-row-before-after-first-empty-row paged diagnostic ---
#set page(margin: 2pt)
#set text(6pt)
#table(
  columns: 3,
...
--- grid-header-auto-pos-cell-inside-conflicts-with-row-after paged diagnostic ---
#set page(margin: 2pt)
#set text(6pt)
#table(
  columns: 2,
...
--- grid-header-row-pos-cell-inside-conflicts-with-row-after paged diagnostic ---
#set page(margin: 2pt)
#set text(6pt)
#table(
  columns: 2,
...
--- grid-header-collision-multiple-ordered paged diagnostic ---
#grid(
  columns: 2,
  grid.cell(x: 0, y: 0)[a],
  grid.cell(x: 1, y: 0)[a],
...
--- grid-header-collision-multiple-unordered paged diagnostic ---
#grid(
  columns: 2,
  grid.cell(x: 0, y: 0)[a],
  grid.cell(x: 1, y: 0)[a],
...
--- grid-header-collision-multiple-rowspan paged diagnostic ---
#grid(
  columns: 2,
  grid.cell(x: 0, y: 0)[a],
  grid.cell(x: 1, y: 0)[a],
...
--- issue-5359-column-override-stays-inside-header render ---
#table(
  columns: 3,
  [Outside],
  table.header(
...
--- issue-6666-auto-hlines-around-header render ---
#table(
	columns: 2,
