...
--- grid-header-no-expand-with-col-and-row-pos-cell render ---
#set page(height: 10em)
#table(
  columns: 2,
  table.header(
...
--- grid-header-no-expand-with-row-pos-cell render ---
#set page(height: 10em)
#table(
  columns: 2,
  table.header(
...
--- grid-header-row-pos-cell-inside-conflicts-with-row-before render ---
#set page(margin: 2pt)
#set text(6pt)
#table(
  columns: 3,
...
--- grid-header-row-pos-cell-inside-conflicts-with-row-before-after-first-empty-row render ---
#set page(margin: 2pt)
#set text(6pt)
#table(
  columns: 3,
...
--- grid-header-auto-pos-cell-inside-conflicts-with-row-after render ---
#set page(margin: 2pt)
#set text(6pt)
#table(
  columns: 2,
...
--- grid-header-row-pos-cell-inside-conflicts-with-row-after render ---
#set page(margin: 2pt)
#set text(6pt)
#table(
  columns: 2,
...
--- grid-header-collision-multiple-ordered render ---
#grid(
  columns: 2,
  grid.cell(x: 0, y: 0)[a],
  grid.cell(x: 1, y: 0)[a],
...
--- grid-header-collision-multiple-unordered render ---
#grid(
  columns: 2,
  grid.cell(x: 0, y: 0)[a],
  grid.cell(x: 1, y: 0)[a],
...
--- grid-header-collision-multiple-rowspan render ---
#grid(
  columns: 2,
  grid.cell(x: 0, y: 0)[a],
  grid.cell(x: 1, y: 0)[a],
