...
--- grid-footer-not-at-last-row render ---
...
--- grid-footer-not-at-last-row-two-columns render ---
...
--- grid-footer-row-pos-cell-inside-conflicts-with-row-after render ---
#set page(margin: 2pt)
#set text(6pt)
#table(
  columns: 2,
...
--- grid-footer-conflicts-with-empty-header render ---
#table(
  columns: 2,
  table.header(),
  table.footer(
