...
--- grid-footer-gutter-and-no-repeat render ---
...
--- grid-cell-override-in-header-and-footer render ---
#table(
  table.header(table.cell(stroke: red)[Hello]),
  table.footer(table.cell(stroke: aqua)[Bye]),
)

--- grid-cell-override-in-header-and-footer-with-gutter render ---
#table(
  gutter: 3pt,
  table.header(table.cell(stroke: red)[Hello]),
  table.footer(table.cell(stroke: aqua)[Bye]),
...
--- grid-footer-relative-row-sizes render ---
// Relative lengths
#set page(height: 10em)
#table(
  rows: (30%, 30%, auto),
...
--- grid-footer-cell-with-y render ---
#grid(
...
--- grid-footer-cell-with-x render ---
#grid(
  columns: 2,
  stroke: black,
  inset: 5pt,
...
--- grid-footer-no-expand-with-col-and-row-pos-cell render ---
#grid(
  columns: 2,
  [a], [],
  [b], [],
...
--- grid-footer-no-expand-with-row-pos-cell render ---
#grid(
  columns: 2,
  [a], [],
  [b], [],
...
--- grid-footer-moved-to-bottom-of-rowspans render ---
#grid(
  columns: 2,
  [a], [],
  [b], [],
...
--- grid-footer-not-at-last-row paged diagnostic ---
...
--- grid-footer-not-at-last-row-two-columns paged diagnostic ---
...
--- grid-footer-overlap paged diagnostic ---
#grid(
  columns: 2,
  grid.header(),
...
--- grid-footer-rowbreak-line render ---
#grid(
  columns: 1,
  [a],
...
--- grid-footer-multiple paged diagnostic ---
...
--- table-footer-in-grid paged diagnostic ---
...
--- grid-footer-in-table paged diagnostic ---
...
--- grid-header-footer-and-rowspan-non-contiguous-1 render ---
...
--- grid-header-footer-and-rowspan-non-contiguous-2 render ---
...
--- grid-header-and-footer-lack-of-space render ---
...
--- grid-header-and-footer-orphan-prevention render ---
...
--- grid-header-and-footer-empty render ---
...
--- grid-header-and-footer-containing-rowspan render ---
...
--- grid-nested-with-footers render ---
...
--- grid-footer-bare-1 render ---
#set page(height: 5em)
#table(
  table.footer[a][b][c]
)

--- grid-footer-bare-2 render ---
...
--- grid-footer-repeatable-unbreakable render ---
...
--- grid-footer-non-repeatable-unbreakable render ---
#set page(height: 8em, width: auto)
#table(
  [h],
  table.footer(
...
--- grid-footer-stroke-edge-cases render ---
...
--- grid-footer-hline-and-vline-1 render ---
...
--- grid-footer-hline-and-vline-2 render ---
...
--- grid-footer-top-hlines-with-only-row-pos-cell render ---
...
--- grid-footer-top-hlines-with-row-and-auto-pos-cell render ---
#set page(margin: 2pt)
#set text(6pt)
#table(
  columns: 3,
...
--- grid-footer-below-rowspans render ---
...
--- grid-footer-row-pos-cell-inside-conflicts-with-row-before render ---
#set page(margin: 2pt)
#set text(6pt)
#table(
  columns: 3,
...
--- grid-footer-auto-pos-cell-inside-conflicts-with-row-after render ---
#set page(margin: 2pt)
#set text(6pt)
#table(
  columns: 2,
...
--- grid-footer-row-pos-cell-inside-conflicts-with-row-after paged diagnostic ---
#set page(margin: 2pt)
#set text(6pt)
#table(
  columns: 2,
...
--- grid-footer-conflicts-with-empty-header paged diagnostic ---
#table(
  columns: 2,
  table.header(),
  table.footer(
...
--- issue-5359-column-override-stays-inside-footer render ---
#table(
  columns: 3,
  [Outside],
  table.footer(
...
--- issue-6666-auto-hlines-around-footer render ---
#table(
	columns: 2,
