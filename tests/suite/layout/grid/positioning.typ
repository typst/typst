...
--- grid-cell-position-out-of-order render ---
...
--- grid-cell-position-extra-rows render ---
...
--- grid-cell-position-collide paged diagnostic ---
...
--- table-cell-position-collide paged diagnostic ---
...
--- grid-cell-position-automatic-skip-manual render ---
...
--- grid-cell-position-x-out-of-bounds paged diagnostic ---
...
--- grid-cell-position-partial render ---
// Partial positioning
#grid(
  columns: 3,
  rows: 1.5em,
...
--- grid-cell-position-partial-collide paged diagnostic ---
...
--- table-cell-position-partial-collide paged diagnostic ---
