...
--- block-multiple-pages-empty render ---
#set page(height: 60pt)
A
#block(height: 30pt)
B

--- block-box-fill render ---
#set page(height: 100pt)
...
--- block-spacing-collapse-text-style render ---
...
--- block-sticky-alone render ---
#set page(height: 50pt)
#block(sticky: true)[A]

--- block-sticky-many render ---
...
--- block-sticky-colbreak render ---
A
#block(sticky: true)[B]
#colbreak()
C

--- block-sticky-breakable render ---
// Ensure that sticky blocks are still breakable.
#set page(height: 60pt)
#block(sticky: true, lines(4))
E

--- box-clip-rect render ---
...
--- box-clip-radius-without-stroke render ---
...
--- container-layoutable-child render ---
...
--- issue-2914-block-fill-skip-nested render ---
...
--- issue-6304-block-skip-label render ---
...
--- issue-6125-block-place-width-limited render ---
...
--- issue-5296-block-sticky-in-block-at-top render ---
#set page(height: 3cm)
#v(1.6cm)
...
--- issue-5296-block-sticky-spaced-from-top-of-page render ---
#set page(height: 3cm)
#v(2cm)
...
--- issue-5296-block-sticky-weakly-spaced-from-top-of-page render ---
#set page(height: 3cm)
#v(2cm, weak: true)
...
--- issue-5262-block-negative-height render ---
#block(height: -1pt)[]

--- issue-5262-block-negative-height-implicit render ---
#set page(height: 10pt, margin: (top: 9pt))
#block(height: 100%)[]

--- issue-5262-block-negative-height-in-flow render ---
...
--- issue-6267-clip-anti-alias render ---
#block(
  clip: true,
  radius: 100%,
