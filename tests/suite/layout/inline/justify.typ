...
--- justify-limits-tracking-wrong-type paged diagnostic ---
...
--- justify-limits-tracking-min-positive paged diagnostic ---
...
--- justify-limits-tracking-max-negative paged diagnostic ---
// Error: 32-66 `max` value of `tracking` is invalid (length must be positive or zero)
#set par(justification-limits: (tracking: (min: -1em, max: -1em)))

--- justify-limits-spacing-max-negative paged diagnostic ---
...
--- justify-limits-spacing-ratio-negative paged diagnostic ---
