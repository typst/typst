...
--- cjk-punctuation-adjustment-1 render ---
#set page(width: 15em)
...
--- issue-2538-cjk-latin-spacing-before-linebreak render ---
// Issue #2538
...
--- issue-6539-cjk-latin-spacing-at-manual-linebreak render ---
// Issue #6539
#set text(cjk-latin-spacing: auto)
...
--- issue-2650-cjk-latin-spacing-meta render ---
测a试

测#context [a]试

--- issue-7113-cjk-latin-spacing-shift render ---
