...
--- issue-1216-clamp-panic paged ---
#set page(height: 20pt, margin: 0pt)
#v(22pt)
#block(fill: red, width: 100%, height: 10pt, radius: 4pt)

--- issue-1918-layout-infinite-length-grid-columns paged ---
