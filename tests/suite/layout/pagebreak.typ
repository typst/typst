...
--- pagebreak-around-set-page render ---
...
--- pagebreak-weak-after-set-page render ---
...
--- pagebreak-set-page-mixed render ---
...
--- pagebreak-followed-by-page-call render ---
...
--- pagebreak-in-container paged diagnostic ---
#box[
...
--- pagebreak-to-auto-sized render ---
...
--- pagebreak-to-multiple-pages render ---
...
--- issue-2134-pagebreak-bibliography render ---
// Test weak pagebreak before bibliography.
#pagebreak(weak: true)
#bibliography("/assets/bib/works.bib")

--- issue-2095-pagebreak-numbering render ---
...
--- issue-2162-pagebreak-set-style render ---
...
--- issue-2591-single-weak-pagebreak render ---
#pagebreak(weak: true)

--- issue-2841-pagebreak-to-weak render ---
First
#pagebreak(to: "odd")
#pagebreak(weak: true)
Odd
