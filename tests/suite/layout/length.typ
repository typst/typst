...
// Hint: 2-21 or use `length.to-absolute()` to resolve its em component (requires context)
#(10.5em - 6pt).pt()
...
// Hint: 2-12 or use `length.to-absolute()` to resolve its em component (requires context)
#(3em).cm()
...
// Hint: 2-20 or use `length.to-absolute()` to resolve its em component (requires context)
#(93em - 80mm).mm()
...
// Hint: 2-24 or use `length.to-absolute()` to resolve its em component (requires context)
#(4.5em + 6in).inches()
