...
--- show-unknown-field paged diagnostic ---
...
--- show-selector-not-an-element-function paged diagnostic ---
// Error: 7-12 only element functions can be used as selectors
#show upper: it => {}

--- show-selector-shadowed-builtin paged diagnostic ---
#let heading = 0
...
--- show-selector-shadowed-builtin-with-std render ---
#let heading = "bar"
#show std.heading: it => text(fill: red, it)
= #heading

--- show-bad-replacement-type paged diagnostic ---
// Error: 16-20 expected content or function, found integer
#show heading: 1234
= Heading

--- show-bad-selector-type paged diagnostic ---
// Error: 7-10 expected symbol, string, label, function, regex, or selector, found color
#show red: []

--- show-selector-in-expression paged diagnostic ---
...
--- show-bare-in-expression paged diagnostic ---
// Error: 4-19 show is only allowed directly in code and content blocks
#((show: body => 2) * body)

--- show-bare-missing-colon-closure paged diagnostic ---
// Error: 6 expected colon
#show it => {}

--- show-bare-missing-colon paged diagnostic ---
// Error: 6 expected colon
#show it
...
--- show-selector-element-or-text paged diagnostic ---
...
--- show-delayed-error paged diagnostic ---
...
--- issue-5690-oom-par-box paged diagnostic ---
