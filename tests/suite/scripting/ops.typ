...
--- ops-add-content render ---
// Test adding content.
#([*Hello* ] + [world!])

--- ops-unary-basic render ---
// Test math operators.
...
--- ops-add-too-large render ---
// Error: 3-26 value is too large
#(9223372036854775807 + 1)

--- ops-binary-basic render ---
// Subtraction.
#test(1-4, 3*-1)
#test(4cm - 2cm, 2cm)
...
--- ops-binary-decimal-multiplication-division-imprecision render ---
...
--- ops-assign-unknown-var-lhs render ---
#{
...
--- ops-assign-unknown-var-rhs render ---
#{
  let a = 2
  a = 1-a
  a = a -1
...
--- ops-assign-unknown-parenthesized-variable render ---
// Error: 4-5 unknown variable: x
#((x) = "")

--- ops-assign-destructuring-unknown-variable render ---
// Error: 4-5 unknown variable: x
#((x,) = (1,))

--- ops-assign-to-temporary render ---
// Error: 3-8 cannot mutate a temporary value
#(1 + 2 += 3)

--- ops-assign-to-invalid-unary-op render ---
// Error: 2:3-2:8 cannot apply 'not' to string
#let x = "Hey"
#(not x = "a")

--- ops-assign-to-invalid-binary-op render ---
// Error: 7-8 unknown variable: x
#(1 + x += 3)

--- ops-assign-unknown-variable render ---
// Error: 3-4 unknown variable: z
#(z = 1)

--- ops-assign-to-std-constant render ---
// Error: 3-7 cannot mutate a constant: rect
#(rect = "hi")

--- ops-assign-to-shadowed-std-constant render ---
