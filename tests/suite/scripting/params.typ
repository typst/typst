--- param-underscore-missing-argument paged diagnostic ---
...
--- params-sink-bool-invalid paged diagnostic ---
// Error: 10-14 expected pattern, found boolean
#let f(..true) = none

--- params-sink-multiple-invalid paged diagnostic ---
...
--- params-sink-missing-arguments paged diagnostic ---
#{
  let f(..a, b, c, d) = none
...
--- issue-1351-parameter-dictionary paged diagnostic ---
