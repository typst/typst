...
--- let-incomplete paged diagnostic ---
...
--- underscore-invalid paged diagnostic ---
#let _ = 4
...
--- let-function-incomplete paged diagnostic ---
...
--- let-function-parenthesized paged diagnostic ---
// This is not yet parsed in the ideal way.
// Error: 12 expected equals sign
#let (func)(x)

--- let-function-parenthesized-with-init paged diagnostic ---
// These errors aren't great.
// Error: 12 expected equals sign
// Error: 15-15 expected semicolon or line break
#let (func)(x) = 3

--- let-with-no-init-group paged diagnostic ---
// This was unintentionally allowed ...
// Error: 9 expected equals sign
#let (a)

--- let-with-no-init-destructuring paged diagnostic ---
// ... where this wasn't.
// Error: 12 expected equals sign
#let (a, b)

--- issue-4027-let-binding-with-keyword-context paged diagnostic ---
...
--- issue-4027-let-binding-with-keyword-let paged diagnostic ---
// Error: 6-9 expected pattern, found keyword `let`
// Hint: 6-9 keyword `let` is not allowed as an identifier; try `let_` instead
#let let = 5

--- issue-4027-let-binding-with-destructured-keywords paged diagnostic ---
