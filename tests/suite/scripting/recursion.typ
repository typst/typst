...
--- recursion-unnamed-invalid paged diagnostic ---
...
--- recursion-maximum-depth paged diagnostic ---
// Error: 15-21 maximum function call depth exceeded
#let rec(n) = rec(n) + 1
#rec(1)

--- recursion-via-include-in-layout paged diagnostic ---
...
--- recursion-show-math paged diagnostic ---
...
--- recursion-show-math-realize paged diagnostic ---
