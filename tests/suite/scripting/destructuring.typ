...
--- destructuring-dict-bad paged diagnostic ---
...
--- destructuring-let-array-with-unnamed-sink paged diagnostic ---
...
--- destructuring-let-empty-array-too-many-elements paged diagnostic ---
...
--- destructuring-let-array-too-few-elements paged diagnostic ---
...
--- destructuring-let-array-too-few-elements-with-sink paged diagnostic ---
...
--- destructuring-let-array-too-few-elements-with-sink-1-element paged diagnostic ---
...
--- destructuring-let-array-bool-invalid paged diagnostic ---
...
--- destructuring-let-dict-key-string-invalid paged diagnostic ---
// Keyed destructuring is not currently supported.
// Error: 7-18 expected pattern, found string
#let ("spacy key": val) = ("spacy key": 123)
#val

--- destructuring-let-dict-key-expr-invalid paged diagnostic ---
// Keyed destructuring is not currently supported.
#let x = "spacy key"
// Error: 7-10 expected identifier, found group
#let ((x): v) = ("spacy key": 123)

--- destructuring-let-array-trailing-placeholders paged diagnostic ---
...
--- destructuring-let-dict-patterns-invalid paged diagnostic ---
// Error: 10-13 expected pattern, found string
// Error: 18-19 expected pattern, found integer
#let (a: "a", b: 2) = (a: 1, b: 2)

--- destructuring-let-dict-shorthand-missing-key paged diagnostic ---
// Error: 10-11 dictionary does not contain key "b"
#let (a, b) = (a: 1)

--- destructuring-let-dict-missing-key paged diagnostic ---
// Error: 10-11 dictionary does not contain key "b"
#let (a, b: b) = (a: 1)

--- destructuring-let-dict-from-array paged diagnostic ---
...
--- issue-3275-loop-over-content paged diagnostic ---
// Error: 11-17 cannot loop over content
#for x in [1, 2] {}

--- issue-3275-loop-over-arguments paged diagnostic ---
// Error: 11-25 cannot loop over arguments
#for _ in arguments("a") {}

--- issue-3275-loop-over-integer paged diagnostic ---
// Error: 16-21 cannot loop over integer
#for (x, y) in 12306 {}

--- issue-3275-destructuring-loop-over-content paged diagnostic ---
// Error: 16-22 cannot loop over content
#for (x, y) in [1, 2] {}

--- issue-3275-destructuring-loop-over-string paged diagnostic ---
// Error: 6-12 cannot destructure values of string
#for (x, y) in "foo" {}

--- issue-3275-destructuring-loop-over-string-array paged diagnostic ---
// Error: 6-12 cannot destructure string
#for (x, y) in ("foo", "bar") {}

--- issue-3275-destructuring-loop-over-bytes paged diagnostic ---
// Error: 6-12 cannot destructure values of bytes
#for (x, y) in bytes("😊") {}

--- issue-3275-destructuring-loop-over-bytes-array paged diagnostic ---
// Error: 6-12 cannot destructure bytes
#for (x, y) in (bytes((1,2)), bytes((1,2))) {}

--- issue-3275-destructuring-loop-over-int-array paged diagnostic ---
// Error: 6-12 cannot destructure integer
#for (x, y) in (1, 2) {}

--- issue-3275-destructuring-loop-over-2d-array-1 paged diagnostic ---
...
--- issue-3275-destructuring-loop-over-2d-array-2 paged diagnostic ---
...
--- issue-4573-destructuring-unclosed-delimiter paged diagnostic ---
