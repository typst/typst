...
--- import-items-parenthesized-invalid paged diagnostic ---
// Error: 23-24 unclosed delimiter
#import "module.typ": (a, b, c

--- import-items-parenthesized-invalid-2 paged diagnostic ---
// Error: 23-24 unclosed delimiter
#import "module.typ": (

--- import-items-parenthesized-invalid-3 paged diagnostic ---
// Error: 23-24 unclosed delimiter
#import "module.typ": (
  a, b,
  c,
...
--- import-from-file-bare-invalid paged diagnostic ---
...
--- import-from-dict-field-bare paged diagnostic ---
#let d = (p: "module.typ")
...
--- import-from-function-scope-bare paged diagnostic ---
...
--- import-from-module-bare paged diagnostic ---
...
--- import-module-item-name-mutating paged diagnostic ---
...
--- import-item-rename-unnecessary paged diagnostic ---
// Warning: 23-27 unnecessary import rename to same name
#import enum: item as item

--- import-rename-unnecessary paged diagnostic ---
...
--- import-rename-unnecessary-mixed paged diagnostic ---
// Warning: 17-21 unnecessary import rename to same name
...
--- import-from-closure-invalid paged diagnostic ---
// Can't import from closures.
#let f(x) = x
// Error: 9-10 cannot import from user-defined functions
#import f: x

--- import-from-closure-renamed-invalid paged diagnostic ---
// Can't import from closures, despite renaming.
#let f(x) = x
// Error: 9-10 cannot import from user-defined functions
#import f as g

--- import-from-with-closure-invalid paged diagnostic ---
// Can't import from closures, despite modifiers.
#let f(x) = x
// Error: 9-18 cannot import from user-defined functions
#import f.with(5): x

--- import-from-with-closure-literal-invalid paged diagnostic ---
// Error: 9-18 cannot import from user-defined functions
#import () => {5}: x

--- import-from-int-invalid paged diagnostic ---
// Error: 9-10 expected path, module, function, or type, found integer
#import 5: something

--- import-from-int-renamed-invalid paged diagnostic ---
// Error: 9-10 expected path, module, function, or type, found integer
#import 5 as x

--- import-from-string-invalid paged diagnostic ---
// Error: 9-11 failed to load file (is a directory)
#import "": name

--- import-from-string-renamed-invalid paged diagnostic ---
// Error: 9-11 failed to load file (is a directory)
#import "" as x

--- import-file-not-found-invalid paged diagnostic ---
// Error: 9-20 file not found (searched at tests/suite/scripting/lib/0.2.1)
#import "lib/0.2.1"

--- import-file-not-found-renamed-invalid paged diagnostic ---
// Error: 9-20 file not found (searched at tests/suite/scripting/lib/0.2.1)
#import "lib/0.2.1" as x

--- import-file-not-valid-utf-8 paged diagnostic ---
// Some non-text stuff.
// Error: 9-35 file is not valid utf-8
#import "/assets/images/rhino.png"

--- import-item-not-found paged diagnostic ---
// Unresolved import.
// Error: 23-35 unresolved import
#import "module.typ": non_existing

--- import-cyclic paged diagnostic ---
// Cyclic import of this very file.
// Error: 9-23 cyclic import
#import "./import.typ"

--- import-cyclic-in-other-file paged diagnostic ---
...
--- import-renamed-old-name paged diagnostic ---
...
--- import-items-renamed-old-name paged diagnostic ---
...
--- import-nested-invalid-type paged diagnostic ---
// Error: 19-21 expected module, function, or type, found float
#import std: calc.pi.something

--- import-incomplete paged diagnostic ---
// Error: 8 expected expression
#import

--- import-item-string-invalid paged diagnostic ---
// Error: 26-29 unexpected string
#import "module.typ": a, "b", c

--- import-bad-token paged diagnostic ---
// Error: 23-24 unexpected equals sign
#import "module.typ": =

--- import-duplicate-comma paged diagnostic ---
// An additional trailing comma.
// Error: 31-32 unexpected comma
#import "module.typ": a, b, c,,

--- import-no-colon paged diagnostic ---
// Error: 2:2 expected semicolon or line break
#import "module.typ
"stuff

--- import-bad-token-star paged diagnostic ---
// A star in the list.
// Error: 26-27 unexpected star
#import "module.typ": a, *, b

--- import-item-after-star paged diagnostic ---
// An item after a star.
// Error: 24 expected semicolon or line break
#import "module.typ": *, a

--- import-bad-colon-in-items paged diagnostic ---
// Error: 14-15 unexpected colon
// Error: 16-17 unexpected integer
#import "": a: 1

--- import-incomplete-nested paged diagnostic ---
// Error: 15 expected identifier
#import "": a.

--- import-wildcard-in-nested paged diagnostic ---
// Error: 15 expected identifier
// Error: 15-16 unexpected star
#import "": a.*

--- import-missing-comma paged diagnostic ---
...
--- import-from-package-dynamic paged diagnostic ---
...
--- import-from-package-required-compiler-version paged diagnostic ---
...
--- import-from-package-namespace-invalid-1 paged diagnostic ---
// Error: 9-13 `@` is not a valid package namespace
#import "@@": *

--- import-from-package-name-missing-1 paged diagnostic ---
// Error: 9-16 package specification is missing name
#import "@heya": *

--- import-from-package-namespace-invalid-2 paged diagnostic ---
// Error: 9-15 `123` is not a valid package namespace
#import "@123": *

--- import-from-package-name-missing-2 paged diagnostic ---
// Error: 9-17 package specification is missing name
#import "@test/": *

--- import-from-package-version-missing-1 paged diagnostic ---
// Error: 9-22 package specification is missing version
#import "@test/mypkg": *

--- import-from-package-name-invalid paged diagnostic ---
// Error: 9-20 `$$$` is not a valid package name
#import "@test/$$$": *

--- import-from-package-version-missing-2 paged diagnostic ---
// Error: 9-23 package specification is missing version
#import "@test/mypkg:": *

--- import-from-package-version-missing-minor paged diagnostic ---
// Error: 9-24 version number is missing minor version
#import "@test/mypkg:0": *

--- import-from-package-version-major-invalid-1 paged diagnostic ---
// Error: 9-29 `latest` is not a valid major version
#import "@test/mypkg:latest": *

--- import-from-package-version-major-invalid-2 paged diagnostic ---
// Error: 9-29 `-3` is not a valid major version
#import "@test/mypkg:-3.0.0": *

--- import-from-package-version-missing-patch-1 paged diagnostic ---
// Error: 9-26 version number is missing patch version
#import "@test/mypkg:0.3": *

--- import-from-package-version-missing-patch-2 paged diagnostic ---
// Error: 9-27 version number is missing patch version
#import "@test/mypkg:0.3.": *

--- import-from-file-package-lookalike paged diagnostic ---
