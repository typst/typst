...
--- closure-capture-mutate paged diagnostic ---
#let x = ()
#let f() = {
...
--- closure-args-sink paged diagnostic ---
// Parameter unpacking.
#let f((a, b), ..c) = (a, b, c)
...
--- closure-param-duplicate-positional paged diagnostic ---
// Error: 11-12 duplicate parameter: x
#let f(x, x) = none

--- closure-body-multiple-expressions paged diagnostic ---
...
--- closure-param-duplicate-mixed paged diagnostic ---
