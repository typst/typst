...
--- get-rule-in-array-callback render ---
...
--- get-rule-figure-caption-collision render ---
...
--- get-rule-assertion-failure paged diagnostic ---
// Error: 10-31 Assertion failed: "en" != "de"
#context test(text.lang, "de")

--- get-rule-unknown-field paged diagnostic ---
// Error: 15-20 function `text` does not contain field `langs`
#context text.langs

--- get-rule-inherent-field paged diagnostic ---
// Error: 18-22 function `heading` does not contain field `body`
#context heading.body

--- get-rule-missing-context-no-context paged diagnostic ---
...
--- get-rule-unknown-field-no-context paged diagnostic ---
// Error: 7-12 function `text` does not contain field `langs`
#text.langs

--- get-rule-inherent-field-no-context paged diagnostic ---
