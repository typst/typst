...
--- get-rule-unknown-field-no-context render ---
// Error: 7-12 function `text` does not contain field `langs`
#text.langs

--- get-rule-inherent-field-no-context render ---
