...
--- method-unknown paged diagnostic ---
// Error: 2:10-2:13 type array has no method `fun`
#let numbers = ()
#numbers.fun()

--- method-unknown-but-field-exists paged diagnostic ---
