...
--- code-block-scope-in-markup paged diagnostic ---
...
--- code-block-scope-in-let paged diagnostic ---
...
--- code-block-double-scope paged diagnostic ---
...
--- code-block-multiple-literals-without-semicolon paged diagnostic ---
// Multiple unseparated expressions in one line.
// Error: 4 expected semicolon or line break
#{1 2}

--- code-block-multiple-expressions-without-semicolon paged diagnostic ---
// Error: 13 expected semicolon or line break
// Error: 23 expected semicolon or line break
#{let x = -1 let y = 3 x + y}

--- code-block-incomplete-expressions paged diagnostic ---
#{
...
--- code-block-unclosed paged diagnostic ---
// Error: 2-3 unclosed delimiter
#{

--- code-block-unopened paged diagnostic ---
// Error: 2-3 unexpected closing brace
#}

--- single-right-bracket paged diagnostic ---
// Error: 1-2 unexpected closing bracket
// Hint: 1-2 try using a backslash escape: \]
]

--- right-bracket-nesting paged diagnostic ---
[
= [ Hi ]]
- how [
  - are ]
...
--- right-bracket-hash paged diagnostic ---
// Error: 2-3 unexpected closing bracket
#]

--- right-bracket-in-blocks paged diagnostic ---
...
--- content-block-in-markup-scope paged diagnostic ---
