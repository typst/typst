...
--- call-bad-type-bool-literal paged diagnostic ---
// Error: 2-6 expected function, found boolean
#true()

--- call-bad-type-string-var paged diagnostic ---
#let x = "x"

// Error: 2-3 expected function, found string
#x()

--- call-shadowed-builtin-function paged diagnostic ---
#let image = "image"
...
--- call-bad-type-int-expr paged diagnostic ---
#let f(x) = x

// Error: 2-6 expected function, found integer
#f(1)(2)

--- call-bad-type-content-expr paged diagnostic ---
#let f(x) = x
...
--- call-args-missing-comma paged diagnostic ---
// Error: 8 expected comma
#func(1 2)

--- call-args-bad-name-and-incomplete-pair paged diagnostic ---
// Error: 7-8 expected identifier, found integer
// Error: 9 expected expression
#func(1:)

--- call-args-bad-name-int paged diagnostic ---
// Error: 7-8 expected identifier, found integer
#func(1:2)

--- call-args-bad-name-string paged diagnostic ---
// Error: 7-12 expected identifier, found string
#func("abc": 2)

--- call-args-bad-name-group paged diagnostic ---
...
--- call-args-spread-string-invalid paged diagnostic ---
// Error: 11-19 cannot spread string
#calc.min(.."nope")

--- call-args-content-block-unclosed paged diagnostic ---
...
--- call-args-unclosed paged diagnostic ---
// Error: 7-8 unclosed delimiter
#{func(}

--- call-args-unclosed-string paged diagnostic ---
// Error: 6-7 unclosed delimiter
