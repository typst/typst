...
--- while-loop-condition-content-invalid paged diagnostic ---
// Condition must be boolean.
// Error: 8-14 expected boolean, found content
#while [nope] [nope]

--- while-loop-condition-always-true paged diagnostic ---
// Error: 8-25 condition is always true
#while 2 < "hello".len() {}

--- while-loop-limit paged diagnostic ---
// Error: 2:2-2:24 loop seems to be infinite
#let i = 1
#while i > 0 { i += 1 }

--- while-loop-incomplete paged diagnostic ---
