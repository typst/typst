...
--- par-leading-and-spacing render ---
...
--- par-spacing-context render ---
#set par(spacing: 10pt)
#context test(par.spacing, 10pt)

--- par-first-line-indent render ---
...
--- par-first-line-indent-all render ---
#set par(
...
--- par-first-line-indent-all-list render ---
...
--- par-first-line-indent-all-enum render ---
...
--- par-spacing-and-first-line-indent render ---
// This is madness.
...
--- par-trailing-whitespace render ---
// Ensure that trailing whitespace layouts as intended.
#box(fill: aqua, " ")

--- par-contains-parbreak render ---
#par[
  Hello
...
--- par-metadata-after-trimmed-space render ---
...
--- par-explicit-trim-space render ---
A

#par[ B ]

--- issue-4278-par-trim-before-equation render ---
#set par(justify: true)
#lorem(6) aa $a = c + b$

--- issue-4938-par-bad-ratio render ---
#set par(justify: true)
#box($k in NN_0$)

--- issue-4770-par-tag-at-start render ---
#h(0pt) #box[] <a>

#context test(query(<a>).len(), 1)

--- issue-5831-par-constructor-args render ---
...
--- show-par-set-block-hint paged diagnostic ---
