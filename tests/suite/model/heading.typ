...
--- heading-syntax-at-start render ---
...
--- heading-trailing-whitespace render ---
...
--- heading-leading-whitespace render ---
...
--- heading-hanging-indent-auto render ---
#set heading(numbering: "1.1.a.")
= State of the Art

--- heading-hanging-indent-auto-center-align render ---
#set heading(numbering: "1.1.a.")
#show heading: set align(center)
= Center aligned

--- heading-hanging-indent-zero render ---
#set heading(numbering: "1.1.a.", hanging-indent: 0pt)
= State of the Art

--- heading-hanging-indent-length render ---
#set heading(numbering: "1.1.a.", hanging-indent: 2em)
= State of the Art In Multi-Line

--- heading-offset-and-level render ---
...
--- heading-syntax-edge-cases render ---
// Edge cases.
...
--- heading-numbering-hint paged diagnostic ---
= Heading <intro>
...
--- issue-5719-heading-nested render ---
