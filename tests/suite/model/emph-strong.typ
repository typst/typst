...
--- emph-empty-hint paged diagnostic ---
...
--- emph-unclosed paged diagnostic ---
// Error: 6-7 unclosed delimiter
#box[_Scoped] to body.

--- emph-ends-at-parbreak paged diagnostic ---
...
--- emph-strong-unclosed-nested paged diagnostic ---
