--- parser-depth-exceeded-balanced paged diagnostic ---
#{
  let s = "()"
  let pat = "({})"
  for _ in range(255) {
...
--- parser-depth-exceeded-unbalanced paged diagnostic ---
// Error: 7-17 unclosed delimiter
// Error: 7-17 maximum parsing depth exceeded
#eval(1024 * "(")

--- parser-depth-exceeded-unbalanced-arrow paged diagnostic ---
...
--- parser-depth-exceeded-unop paged diagnostic ---
