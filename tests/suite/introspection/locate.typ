...
--- locate-missing-label paged diagnostic ---
// Error: 10-25 label `<intro>` does not exist in the document
#context locate(<intro>)

--- locate-duplicate-label paged diagnostic ---
= Introduction <intro>
= Introduction <intro>
...
--- locate-element-selector-no-match paged diagnostic ---
// Error: 10-25 selector does not match any element
#context locate(heading)

--- locate-element-selector-multiple-matches paged diagnostic ---
= Introduction <intro>
= Introduction <intro>
