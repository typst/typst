...
#test(datetime(day:1, month:1, year: 2000).add(), datetime(day:1, month:1, year: 2000))
#test(datetime(day:1, month:1, year: 2000).add(weeks: 2), datetime(day:15, month:1, year: 2000))
#test(datetime(day:1, month:1, year: 2000).add(days: 3), datetime(day:4, month:1, year: 2000))
#test(datetime(day:1, month:1, year: 2000).add(weeks: 1, days: 3), datetime(day:11, month:1, year: 2000))
#test(datetime(day:31, month:1, year: 2000).add(days: 1), datetime(day:1, month:2, year: 2000))
#test(datetime(day:31, month:12, year: 2000).add(days: 1), datetime(day:1, month:1, year: 2001))
#test(datetime(day:1, month:2, year: 2000).add(days: -1), datetime(day:31, month:1, year: 2000))
#test(datetime(day:1, month:2, year: 2000).add(days: -3), datetime(day:29, month:1, year: 2000))
#test(datetime(day:1, month:2, year: 2000).add(weeks: -1), datetime(day:25, month:1, year: 2000))
#test(datetime(day:1, month:1, year: 2000).add(days: -1), datetime(day:31, month:12, year: 1999))
#test(datetime(day:1, month:1, year: 2000).add(weeks: 1, days: -7), datetime(day:1, month:1, year: 2000))
#test(datetime(hour:12, minute: 0, second: 0).add(), datetime(hour:12, minute: 0, second: 0))
#test(datetime(hour:12, minute: 0, second: 0).add(hours:1, minutes: -60), datetime(hour:12, minute: 0, second: 0))
#test(datetime(hour:12, minute: 0, second: 0).add(hours: 2), datetime(hour:14, minute: 0, second: 0))
#test(datetime(hour:12, minute: 0, second: 0).add(minutes: 10), datetime(hour:12, minute: 10, second: 0))
#test(datetime(hour:12, minute: 0, second: 0).add(seconds: 30), datetime(hour:12, minute: 0, second: 30))
#test(datetime(hour:12, minute: 0, second: 0).add(hours: -2), datetime(hour:10, minute: 0, second: 0))
#test(datetime(hour:12, minute: 0, second: 0).add(minutes: -10), datetime(hour:11, minute: 50, second: 0))
#test(datetime(hour:12, minute: 0, second: 0).add(seconds: -30), datetime(hour:11, minute: 59, second: 30))
#test(datetime(hour:12, minute: 0, second: 0).add(hours: 1, minutes: 13, seconds: 13), datetime(hour:13, minute: 13, second: 13))
#test(datetime(day:1, month:1, year: 2000, hour:12, minute: 0, second: 0).add(), datetime(day:1, month:1, year: 2000, hour:12, minute: 0, second: 0).add())
#test(datetime(day:1, month:1, year: 2000, hour:12, minute: 0, second: 0).add(weeks:1, days: 3, hours: -13, minutes: 10, seconds: -10 ), datetime(day:10, month:1, year: 2000, hour:23, minute: 9, second: 50).add())
#test(datetime(day:1, month:1, year: 2000).duration-to(datetime(day:1, month:2, year: 2000), "days"), 31)
#test(datetime(day:1, month:1, year: 2000).duration-to(datetime(day:15, month:1, year: 2000), "weeks"), 2)
#test(datetime(hour:12, minute: 0, second: 0).duration-to(datetime(hour:14, minute: 0, second: 0), "hours"), 2)
#test(datetime(hour:12, minute: 0, second: 0).duration-to(datetime(hour:14, minute: 0, second: 0), "minutes"), 120)
#test(datetime(hour:12, minute: 0, second: 0).duration-to(datetime(hour:12, minute: 30, second: 0), "hours"), 0.5)
#test(datetime(hour:12, minute: 0, second: 0).duration-to(datetime(hour:13, minute: 0, second: 0), "seconds"), 3600)