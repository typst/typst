...
---
// Count figures.
#figure(numbering: "A", caption: [Four 'A's], contents: image, supplement: "Figure")[_AAAA!_]
#figure(numbering: none, caption: [Four 'B's], contents: image, supplement: "Figure")[_BBBB!_]
#figure(caption: [Four 'C's], contents: image, supplement: "Figure")[_CCCC!_]
#counter(figure.where(contents: image)).update(n => n + 3)
#figure(caption: [Four 'D's], contents: image, supplement: "Figure")[_DDDD!_]
