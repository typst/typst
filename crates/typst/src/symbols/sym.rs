...
pub(crate) const SYM: &[(&str, Symbol)] = symbols! {
    ...
    dot: [
        #[call(crate::math::dot)] op: '⋅',
        basic: '.',
        c: '·',
        circle: '⊙',
        circle.big: '⨀',
        square: '⊡',
        #[call(crate::math::dot_double)] double: '¨',
        #[call(crate::math::dot_triple)] triple: '\u{20db}',
        #[call(crate::math::dot_quad)] quad: '\u{20dc}',
    ],
    ...
    acute: [
        ...
        #[call(crate::math::acute_double)] double: '˝',
    ],
    breve: #[call(crate::math::breve)] '˘',
    caret: '‸',
    caron: #[call(crate::math::caron)] 'ˇ',
    hat: #[call(crate::math::hat)] '^',
    diaer: #[call(crate::math::dot_double)] '¨',
    grave: #[call(crate::math::grave)] '`',
    macron: #[call(crate::math::macron)] '¯',
    quote: [
        double: '"',
        single: '\'',
        l.double: '“',
    ...
    bullet: '•',
    circle: [
        #[call(crate::math::circle)] stroked: '○',
        stroked.tiny: '∘',
        stroked.small: '⚬',
        stroked.big: '◯',
        filled: '●',
    ...
    harpoon: [
        #[call(crate::math::harpoon)] rt: '⇀',
        rt.bar: '⥛',
        rt.stop: '⥓',
        rb: '⇁',
        rb.bar: '⥟',
        rb.stop: '⥗',
        #[call(crate::math::harpoon_lt)] lt: '↼',
        lt.bar: '⥚',
        lt.stop: '⥒',
        lb: '↽',
        lb.bar: '⥞',
