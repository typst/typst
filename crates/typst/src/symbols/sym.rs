...
pub(crate) const SYM: &[(&str, Symbol)] = symbols! {
    ...
    backslash: [
        '\\',
        circle: '⦸',
        not: '⧷', // U+29F7 REVERSE SOLIDUS WITH HORIZONTAL STROKE
        bar: '⍀', // U+2340 APL FUNCTIONAL SYMBOL BACKSLASH BAR
    ],
    co: '℅',
    ...
    tack: [
     ...
     // Miscellaneous non-letter-like symbols.
     house: '⌂',
     projective: '⌅',
     perspective: '⌆',
     viewdata: '⌗',
