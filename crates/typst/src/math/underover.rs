...
impl LayoutMath for UnderlineElem {
    #[typst_macros::trace(name = "math.underline", span = self.span())]
...
impl LayoutMath for OverlineElem {
    #[typst_macros::trace(name = "math.overline", span = self.span())]
    fn layout_math(&self, ctx: &mut MathContext) -> SourceResult<()> {
...
impl LayoutMath for UnderbraceElem {
    #[typst_macros::trace(name = "math.underbrace", span = self.span())]
    fn layout_math(&self, ctx: &mut MathContext) -> SourceResult<()> {
...
impl LayoutMath for OverbraceElem {
    #[typst_macros::trace(name = "math.overbrace", span = self.span())]
    fn layout_math(&self, ctx: &mut MathContext) -> SourceResult<()> {
        layout_underoverspreader(
            ctx,
            self.body(),
...
impl LayoutMath for OverbracketElem {
    #[typst_macros::trace(name = "math.overbracket", span = self.span())]
    fn layout_math(&self, ctx: &mut MathContext) -> SourceResult<()> {
        layout_underoverspreader(
            ctx,
            self.body(),
