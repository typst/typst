...
impl Show for UnderlineElem {
    #[typst_macros::trace(name = "underline", span = self.span())]
...
impl Show for OverlineElem {
    #[typst_macros::trace(name = "overline", span = self.span())]
    fn show(&self, _: &mut Engine, styles: StyleChain) -> SourceResult<Content> {
        Ok(self.body().clone().styled(TextElem::set_deco(Decoration {
...
impl Show for StrikeElem {
    #[typst_macros::trace(name = "strike", span = self.span())]
    fn show(&self, _: &mut Engine, styles: StyleChain) -> SourceResult<Content> {
        Ok(self.body().clone().styled(TextElem::set_deco(Decoration {
...
impl Show for HighlightElem {
    #[typst_macros::trace(name = "highlight", span = self.span())]
    fn show(&self, _: &mut Engine, styles: StyleChain) -> SourceResult<Content> {
        Ok(self.body().clone().styled(TextElem::set_deco(Decoration {
