...
///               --out crates/typst/data/icudata.postcard  \
///               --overwrite
/// ```
///
/// Install icu_datagen with `cargo install icu_datagen`.
static ICU_DATA: &[u8] = include_bytes!("../../../data/icu.postcard");
...
///               --out crates/typst/data/icudata-cj-linebreak.postcard \
///               --overwrite
/// ```
///
/// The used icu_datagen should be patched by
/// https://github.com/peng1999/icu4x/commit/b9beb6cbf633d61fc3d7983e5baf7f4449fbfae5
static ICU_CJ_SEGMENT_DATA: &[u8] =
    include_bytes!("../../../data/icu-cj-segment.postcard");
...
static CJ_SEGMENTER: Lazy<LineSegmenter> = Lazy::new(|| {
    let provider = BlobDataProvider::try_new_from_static_blob(ICU_DATA).unwrap();
    let cj_blob =
        BlobDataProvider::try_new_from_static_blob(ICU_CJ_SEGMENT_DATA).unwrap();
