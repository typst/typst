...
/// [`SyntaxNode::synthesize_with`](super::SyntaxNode::synthesize_with) to have
/// accurate error spans for source text that is non-consecutive in its source
/// file (for instance, Typst code in a doc comment with start-of-line slashes).
#[derive(Hash)]
