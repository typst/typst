...
/// #calc.asinh(1)
/// ```
#[func(title = "Inverse Hyperbolic Sine", since = "{FUTURE_TYPST_RELEASE}")]
pub fn asinh(
...
/// #calc.acosh(2.5)
/// ```
#[func(title = "Inverse Hyperbolic Cosine", since = "{FUTURE_TYPST_RELEASE}")]
pub fn acosh(
...
/// #calc.atanh(0.5)
/// ```
#[func(title = "Inverse Hyperbolic Tangent", since = "{FUTURE_TYPST_RELEASE}")]
pub fn atanh(
...
/// #calc.erf(0.2)
/// ```
#[func(title = "Error Function", since = "{FUTURE_TYPST_RELEASE}")]
pub fn erf(
