...
///
/// Within math mode, function calls have special behaviour. See the @math[math
...
/// @reference:styling:set-rules[set rules], @reference:styling:show-rules[show
///   rules], and @selector[selectors].
///
...
/// You can define your own function with a @reference:scripting:bindings[let
///   binding] that has a parameter list after the binding's name. The parameter
/// list can contain mandatory positional parameters, named parameters with
/// default values and @arguments[argument sinks].
///
