...
/// only available when you enable the `a11y-extras` feature (see the @pdf[PDF
...
/// @table.stroke[table's `stroke`] field or @table.cell.stroke[`table.cell`'s
///   `stroke`] field instead if the line you want to place is part of all your
/// tables' designs.
