...
/// table cells, you can use the [`table.cell`] element. See its
...
/// ```
///
/// Much like with grids, you can use [`table.cell`] to customize
...
pub struct TableElem {
    ...
    /// with the [`table.hline`] and
    /// [`table.vline`] elements.
    #[variadic]
...
///
/// Just like the [`table.header`] element, the footer can repeat
...
///
/// Similar to [`table.hline`], use this function if you want to
