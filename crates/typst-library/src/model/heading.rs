...
pub struct HeadingElem {
    ...
    ///
    /// This is primarily useful for usage in @reference:styling:show-rules[show
    ///   rules] (either with @function.where[`where`] selectors or by accessing
    /// the level directly on a shown heading).
    ///
    /// ```example
    ...
    /// How to number the heading. Accepts a @numbering[numbering pattern or
    ///   function] taking multiple numbers.
    ///
    /// ```example
    /// #set heading(numbering: "1.a.")
    ///
