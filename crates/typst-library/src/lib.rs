...
fn info_module() -> Module {
    ...
    version_dict.insert("major".into(), env!("CARGO_PKG_VERSION_MAJOR").into_value());
    version_dict.insert("minor".into(), env!("CARGO_PKG_VERSION_MINOR").into_value());
    version_dict.insert("patch".into(), env!("CARGO_PKG_VERSION_PATCH").into_value());
