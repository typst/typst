...
/// up a lot of space. If you are concerned about file sizes, you should
...
///   @color.oklch color spaces are stored as a list of @color.rgb colors with
///   extra stops in between. This avoids needing to encode these color spaces
///   in your PDF file, but it does add extra stops to your gradient, which can
