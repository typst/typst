...
fn layout_page_run_impl(
    ...
    let fill = styles.get(PageElem::fill);
    ...
    let numbering = styles.get(PageElem::numbering);
    let supplement = match styles.get(PageElem::supplement) {
    ...
    let header = styles.get(PageElem::header);
    let footer = styles.get(PageElem::footer);
