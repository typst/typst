...
//     // inline.push("padding", elem.inset.get(styles).unwrap_or_default());

//     let stroke = elem.stroke.get_cloned(styles).unwrap_or_default();
//     // if !stroke.iter().all(|side| side.is_none()) {}
