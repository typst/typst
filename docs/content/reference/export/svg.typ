#import "../../../components/index.typ": docs-category, func-section, docs-section, prose-styling
...
#docs-section(
  ...
  description: "Documentation for Typst's SVG export target.",
  {
    prose-styling([], base-target: def-target)
...
#let info = stdx.describe(format.svg)
#let route = "/reference/format/svg"
#func-section(
  route,
  "format.svg",
  format.svg,
