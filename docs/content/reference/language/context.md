...
[^1]: Currently, all show rules provide [style context]($context/#style-context),
      but only show rules on [locatable]($location/#locatable) elements provide
      a [location context]($context/#location-context).
