...
Default representation: #date.display() \
Custom representation: #date.display("Last two digits of year: [year padding:zero repr:last_two] Month: [month padding:zero], Weekday: [weekday repr:monday one_indexed:true] ([weekday repr:long]), Day: [day padding:none]")

#let time = datetime(hour: 18, minute: 2, second: 23)
