...
- Typst now supports the PDF versions PDF 1.4, PDF 1.5, PDF 1.6, and PDF 2.0 in addition to PDF 1.7. See the [PDF documentation]($pdf) for details. [#5420]
...
- Text handling
  ...
  - Generated letters in an equation (e.g. the `√` produced by `sqrt`) can now be targeted by text show rules [#6365]
...
- Autocompletion
  ...
  - Fixed unapplicable method autocompletions being listed [#5824]
- Tooltips
